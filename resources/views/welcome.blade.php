      ...
      <div class="timeline scroll-reveal">
        <div class="timeline-item">
          <div class="timeline-icon">
            <img src="{{ asset('images/icons/wedding-rings.svg') }}" alt="Rings" width="32" height="32" />
          </div>
          <div class="timeline-body">
            <span class="timeline-time">14:30</span>
            <div class="timeline-content">
              <h3>ՊՍԱԿԱԴՐՈՒԹՅՈՒՆ</h3>
              <p>Գեղարդ վանական համալիր</p>
            </div>
          </div>
        </div>
        ...
        <div class="timeline-item">
          <div class="timeline-icon">
            <img src="{{ asset('images/icons/restaurant.svg') }}" alt="Restaurant" width="32" height="32" />
          </div>
          <div class="timeline-body">
        ...
        <div class="timeline-item">
          <div class="timeline-icon">
            <img src="{{ asset('images/icons/cake.svg') }}" alt="Cake" width="32" height="32" />
          </div>
          <div class="timeline-body">
