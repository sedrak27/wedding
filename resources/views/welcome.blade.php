  ...
  <section class="programme" id="programme">
    <div class="section-inner">
      ...
      <div class="programme__cards">
        ...
        <!-- Պսակադրություն -->
        <div class="programme__item scroll-reveal">
          <div class="programme__left">
            <div class="programme__icon">
              <svg fill="#ff8d21" height="44px" width="44px" viewBox="0 0 390.675 390.675" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <div class="programme__item scroll-reveal">
          <div class="programme__left">
            <div class="programme__icon programme__icon--glasses">
              <svg width="26px" height="26px" viewBox="-4.56 0 47.704 47.704" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="26px" height="26px" viewBox="-4.56 0 47.704 47.704" xmlns="http://www.w3.org/2000/svg" style="transform:scaleX(-1)">
                <g transform="translate(-388.601 -233.042)">
                  <path d="M406.108,277.422a1,1,0,0,1-.928-.631c-.147-.367-3.55-9.077-1.02-16.669a1,1,0,1,1,1.9.631c-2.3,6.907.948,15.215.98,15.3a1,1,0,0,1-.929,1.37Z" fill="#ff8d21"/>
                  <path d="M403.339,277.421a1.019,1.019,0,0,1-.369-.07,1,1,0,0,1-.561-1.3c.033-.083,3.274-8.409.981-15.3a1,1,0,0,1,1.9-.631c2.526,7.592-.874,16.3-1.019,16.669A1,1,0,0,1,403.339,277.421Z" fill="#ff8d21"/>
                  <path d="M404.8,280.746c-5.042,0-10.469-1.258-10.469-4.02,0-2.669,4.852-3.555,6.939-3.811a1,1,0,0,1,.244,1.985c-3.781.465-5.14,1.517-5.183,1.827.082.6,3.063,2.019,8.469,2.019s8.387-1.417,8.469-2.022c-.043-.306-1.395-1.353-5.156-1.821a1,1,0,0,1,.246-1.984c2.078.258,6.91,1.146,6.91,3.807C415.266,279.488,409.839,280.746,404.8,280.746Z" fill="#ff8d21"/>
